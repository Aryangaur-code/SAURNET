...
*   ⚠️ **Automated Alerting:** Proactively notifies operators of inverter overloads, grid interconnect issues, and array inefficiencies.
...
# Install dependencies (ensure you have uvicorn and fastapi installed)
...
Open a new terminal, navigate to the project root, and start the Next.js app:
...
*(Check out `sensor_parameters.md` or our technical documentation for a full hardware integration guide).*
